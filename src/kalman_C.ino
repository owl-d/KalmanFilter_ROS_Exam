...
int InvertMatrix(double m[16], double invOut[16]) {
    ...
    det = m[0]*inv[0]+m[1]*inv[4]+m[3]*inv[8]+m[3]*inv[12];
...
//  imu.update();
  ...
  if (millis()-pre_time >= 50)
  {
    ...
    //[8.999999999999999e-08, 0.0, 0.0, 0.0, 8.999999999999999e-08, 0.0, 0.0, 0.0, 8.999999999999999e-08]
    ...
    //sensor value
    gyro[0] = imu.gyroData[0]*0.00106;
    gyro[1] = imu.gyroData[1]*0.00106;
    gyro[2] = imu.gyroData[2]*0.00106; // *3.14/180/16.4
    Serial.print("gyro :");
    ...
    acc[0] = imu.accData[0]*0.0006;
    acc[1] = imu.accData[1]*0.0006;
    acc[2] = imu.accData[2]*0.0006; //*9.8/16384
    Serial.print("acc :");
...
//    mag[0] = imu.magData[0]*1200/4096;
//    mag[1] = imu.magData[1]*1200/4096;
//    mag[2] = imu.magData[2]*1200/4096;
//    Serial.print("mag :");
